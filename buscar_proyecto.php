                ...
                <div class="card">
                 ...
                 <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        echo  "<td><a href='formeditproyectos.php?cp=".$fila['CP']."'> <section class='imgtb'></section></a> </ln>";
    
                         echo "<a href= 'detalleproyecto.php?cp=".$fila['CP']."'><section class='dtl'></section></a> </td>";
                        echo "</tr>";    
