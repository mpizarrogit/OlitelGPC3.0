			...
			<div class="">
			  <div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
				  <h2 class="text-primary">Crear Panel</h2>
            ...
            <div class="row">
             ...
             <?php
			   ...
			   $cp = $_GET['cp'];
                ...
                include ("bd.php");
        $query5="SELECT * from FASE WHERE FASE.ID_FASE ='$idfase'";
              ...
              <div class="col-8 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladorcrearpanel.php">
                        
                         <div class="row">
                             <input type="hidden"  id="proyecto" name="proyecto" value="<?php echo $proyecto;?>">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nombre Panel</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="npanel" id="npanel"/> </div>
                      ...
                      <input type="hidden" class="form-control" name="idfase" id="idfase" value="<?php  echo $idfase ?>"/>
						<input type="hidden" class="form-control" name="cp" id="cp" value="<?php  echo $cp ?>"/>
							...
							<button type="button" class="btn btn-secondary mr-2" onclick="cancelar()">Cancelar</button>
                              <!--<a href="listadofacturascobranza.php"><input class="btn btn-light" type="button" value="Cancelar"></a>-->
