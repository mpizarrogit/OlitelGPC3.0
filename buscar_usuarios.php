    ...
    <div class="container-scroller">
     ...
     <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      $busqueda = strtolower($_REQUEST['busqueda']);
          ...
          <form class="ml-auto search-form d-none d-md-block" action="buscar_usuarios.php" method="get">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="./formproyectosadmin.php">Formulario Proyectos</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="./formagregarusuario.php">Formulario Usuarios</a>
                  </li><!--
                  <li class="nav-item">
      ...
      //Validar conexión.
			...
			$sql_registe = mysqli_query($conexion,"SELECT * FROM PERSONAS WHERE (
            
            RUT LIKE '%$busqueda%' OR
            NOM_PERSONAS LIKE '%$busqueda%' OR
            ID_ROL LIKE '%$busqueda%' 
                ...
                <div class="card">
                 ...
                 <table class="table table-bordered">
                      <thead>
                        <tr>
                          <th id='tmlet'> RUT </th>
                          <th id='tmlet'> NOMBRE</th>
                          <th id='tmlet'> ROL </th>
                          
                          <th id='tmlet'> CLAVE </th>
                      ...
                      <tbody>
                        ...
                        echo "<tr><td id='tmlet'>"; 
                          ...
                          echo $fila['RUT']."</td><td id='tmlet'>";
                          echo $fila['NOM_PERSONAS']."</td><td id='tmlet'>";
                          echo $fila['ID_ROL']."</td><td id='tmlet'>";
                            echo $fila['CLAVE']."</td>";
    
                        echo  "<td><a href='formeditpersonas.php?idpersona=".$fila['ID_PERSONAS']."'> <section class='imgtb'></section></a> </ln>";
    
                         echo "<a href= 'controladoreliminarpersonas.php?idpersona=".$fila['ID_PERSONAS']."'><section class='elim'></section></a> </td>";
                        echo "</tr>";    
