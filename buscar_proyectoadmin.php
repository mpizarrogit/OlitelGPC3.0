  ...
  <body>
    <div class="container-scroller">
      ...
      $busqueda = strtolower($_REQUEST['busqueda']);
          ...
          <form class="ml-auto search-form d-none d-md-block" action="buscar_proyectoadmin.php" method="get">
                 ...
                 <table class="table table-bordered">
                       <thead>
                        <tr>
                         ...
                         PROYECTO</th>
                          ...
                          <th id='tmlet'> AVANCE </th>
                          
                          <th id='tmlet'> ESTADO </th>
                      ...
                      <tbody>
                        ...
                        echo $fila['INI_ASIG']."</td><td id='tmlet'>";
                          ...
                          echo $fila['AVANCE']."% <meter max=100 id='barra' value=".$fila['AVANCE']." low='30' high='60' optimun='100'></meter></td><td id='tmlet'>";

                           echo ucfirst(strtolower($fila['ESTADO']))."</td>";
    
                         echo "<td><a href= 'detalleproyectoadmin.php?cp=".$fila['CP']."'><section class='dtl'></section></a>";
    
                        echo  "<a href='formeditproyectosadmin.php?cp=".$fila['CP']."'> <section class='imgtb'></section></a>";
    
                         echo "<a href= 'controladoreliminaradmin.php?cp=".$fila['CP']."'><section class='elim'></section></a> </td>";
                        echo "</tr>";
