        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
           <li class="nav-item nav-profile">
            ...
            <li class="nav-item nav-category">Menú Principal</li><li class='nav-item'><a class='nav-link' href='./principaladmin.php'><i class='menu-icon fa fa-th'></i><span class='menu-title'>Inicio</span></a></li> 
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
					...
					$consulta2 = "SELECT COUNT(ID_FASE) AS CANT FROM `FASE`, concepto  WHERE FASE.CP = CONCEPTO.CP AND CONCEPTO.CP  = ".$fila['CP'];
					$resultado2 = mysqli_query($conexion, $consulta2);
		  			while($fila2 = mysqli_fetch_array($resultado2)){  
		  		
			  		$cant_fases = $fila2["CANT"];
		  
		  			}
			  
			 
	
					$consulta3 = "SELECT COUNT(ID_FASE) AS COMPLETAS FROM `FASE`, concepto  WHERE  FASE.CP = CONCEPTO.CP AND FASE.AVANCE_FASE = 100 AND CONCEPTO.CP = ".$fila['CP'];
					...
					$cant_comp = $fila3["COMPLETAS"];
						...
						$porcentaje = $cant_comp/$cant_fases;
						$porcentaje = $porcentaje * 100;
					
						$actualizar_porc = "UPDATE CONCEPTO set AVANCE=? WHERE CP=?";
						$resultadofase = mysqli_prepare($conexion, $actualizar_porc);
						if(!$resultadofase){
						echo "Error al editar.";
              
						}
        			$ok=mysqli_stmt_bind_param($resultadofase,"ss",$porcentaje,$fila['CP']);
					$ok=mysqli_stmt_execute($resultadofase);	
                          ...
                          <tr>
                            ...
                            <td> <a href='listadofases.php?cp=<?PHP echo $fila['CP']; ?>'><?php echo $fila['NOMBRE'];?></a></td>
                        ...
                        $row3=$resultado3->fetch_assoc(); ?>
                            ...
                            <td>
                             <a href='formeditproyectosadmin.php?cp=<?PHP echo $fila['CP']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleproyectoadmin.php?cp=<?PHP echo $fila['CP']; ?>'><section class='dtl'></section></a>   
                                
                            <a href= 'controladoreliminaradmin.php?cp=<?php echo $fila['CP']; ?>'><section class='elim'></section></a>
