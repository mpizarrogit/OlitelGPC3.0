              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditarservicioscob.php">
...
<?php 
    ...
    <?php } ?>                  
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <select  class="form-control" name="eo_cob" id="eo_cob">
                            <?php 
         ...
         $query = "SELECT * FROM ESTADO_COBRANZA, concepto where ESTADO_COBRANZA.ID_EO_COB = concepto.ID_EO_COB and concepto.cp = '$cp'";
    ...
    ?> 
        <?php
            ...
            ?>
                ...
                <option value=" <?php echo$rowx['ID_EO_COB'] ?>" selected>
    ...
    <?php } ?>                  
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="valpro" id="valpro" value="<?php  echo $row['VALORPROYECTO']; ?>"/> </div>
                          </div>
                        </div>
                             ...
                             <button type="submit" class="btn btn-success mr-2">Editar</button>
                              <a href="listadoservicios.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
