  ...
  <body>
      ...
      include ("bd.php");
        ...
        $row=$resultado->fetch_assoc();
            ...
            ?>
                ...
                <option value=" <?php echo$row6['ID_TIPO'] ?>">
                <?php echo $row6['NOM_TIPO']; ?>
                </option>
    ...
    <?php } ?>
                  ...
                  <?php 
                            ...
                            $query = "SELECT * FROM TIPO, CONCEPTO WHERE CP = '$cp'";
    ...
    $query = "SELECT ciudad.NOM_CIUDAD as ciudelec, ciudad.ID_CIUDAD as ciudadelecid FROM ciudad, concepto WHERE concepto.CP = '$cp'";
    ...
    ?>  
     ...
     <?php 
            ...
            ?>
                ...
                <option value=" <?php echo$row['ciudelecid'] ?>" selected>
                <?php echo $row2['ciudelec']; ?>
                </option>
...
<?php 
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               ...
                               <input type="date" name="fdinf" id="fdinf" class="form-control"value=<?php echo date('Y-m-d',strtotime($row["TER_REAL"])) ?>   /> </div>
                          </div>
                        </div>
                      </div>    
    ...
    $query = "SELECT personas.NOM_PERSONAS, personas.ID_PERSONAS from personas, comprometidos where comprometidos.ID_PERSONAS = personas.ID_PERSONAS and cp = '$cp' and comprometidos.ID_CARGO = 1 and comprometidos.NI = 10 ";
    ...
    $query = "SELECT personas.NOM_PERSONAS, personas.ID_PERSONAS from personas, comprometidos where comprometidos.ID_PERSONAS = personas.ID_PERSONAS and cp = '$cp' and comprometidos.ID_CARGO = 1 and comprometidos.NI = 20 ";
    ...
    ?>                  
                ...
                ?>
                        ...
                        <option value=" <?php echo $row4['ID_PERSONAS'] ?> " selected>
                        <?php echo $row4['NOM_PERSONAS']; ?>
                        </option>
