      ...
      <!-- partial:partials/_navbar.html -->
       <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          ...
          <form class="ml-auto search-form d-none d-md-block" action="buscar_proyecto.php" method="get">
            <div class="form-group">
              <input name="busqueda" type="search" class="form-control" placeholder="Search Here">
            </div>
          </form>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="./formproyectosadmin.php">Formulario agregar proyecto</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="./formagregarusuario.php">Formulario agregar usuario</a>
                  </li><!--
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="listadoproyectoscobranza.php">Listado proyectos</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="listadoip.php">Listado Informes de pago</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="listadofacturascobranza.php">Listado Factura</a>
                  </li><!--
                  <li class="nav-item">
          ...
          <div class="content-wrapper">
            ...
            ?>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Asignar factura a Informes de pago</h4>
                      
                      
                      
                    <form class="form-sample" method="post" action="controladorfacturarvarios.php">
                      <p class="card-description"> Esta Factura está asignada a: </p>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nfactura" id="nfactura" value="<?php  echo $nfactura ?>"/> </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <section class="form-control"> <?php echo $vfactura; ?> </section> </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <select  class="form-control" name="cfactura" id="cfactura">
                        ...
                        ?>
                             ...
                             <button type="submit" class="btn btn-success mr-2">Enviar</button>
                              ...
                              <a href="listadoip.php"><input class="btn btn-warning" type="button" value="Asignar más"></a>
                        
                        
                              <a href="listadoip.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
