  ...
  <head>
    <!-- Required meta tags -->
      ...
      $ip = $_GET['idpersona'];
        ...
        include ("bd.php");
        $query="SELECT * FROM PERSONAS WHERE ID_PERSONAS ='$ip'";
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoreditarusuario.php">
                      <p class="card-description"> Estás editando el usuario <?php echo $ip; ?></p>
                        
                         <div class="row">
                              <input type="hidden" name="id" id="id" value="<?php echo $ip ?>">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nombre</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nom_usuario" id="nom_usuario" value="<?php echo $row['NOM_PERSONAS']; ?>" /> </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="rut_usuario"  id="rut_usuario" value="<?php echo $row['RUT']; ?>" /> </div>
                          </div>
                      ...
                      <div class="row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="clave_usuario"  id="clave_usuario" value="<?php echo $row['CLAVE']; ?>"/> </div>
                          </div>
                        ...
                        ?>
                         <?php 
                            ...
                            $query2 = "SELECT * FROM PERSONAS, ROL WHERE PERSONAS.ID_ROL = ROL.ID_ROL AND ID_PERSONAS =".$ip;
                        ...
                        <option value=" <?php echo $row2['ID_ROL'] ?> " selected>
                        <?php echo $row2['NOM_ROL']; ?>
                        </option>
                        ...
                        ?>     
                             ...
                             <button type="submit" class="btn btn-success mr-2">Editar</button>
                              <a href="listadopersonas.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
