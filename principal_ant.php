            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
				  ...
				  <li class="nav-item">
                    <a class="nav-link" href="#">Agregar Actividad</a>
                  </li>
                  ...
                  <div class="card-body">
					...
					$ok=mysqli_stmt_execute($resultadofase);	
                          ...
                          <tr>
                            ...
                            <td  class="text-capitalize"><a href='listadofases.php?cp=<?PHP echo $fila['CP']; ?>'><?php echo $fila['NOMBRE'];?></a></td>
                        ...
                        $row3=$resultado3->fetch_assoc(); ?>
                            ...
                            <td>
                             <a href='formeditproyectos.php?cp=<?PHP echo $fila['CP']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleproyecto.php?cp=<?PHP echo $fila['CP']; ?>'><section class='dtl'></section></a>   
