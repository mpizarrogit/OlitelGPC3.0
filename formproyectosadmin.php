          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ingresar proyecto</h4>
                      
                      
                      
                    <form class="form-sample" method="post" action="controladoringresarproyectoadmin.php">
                      <p class="card-description"> Crea los proyectos </p>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nom_pro" id="nom_pro" required /> </div>
                          </div>
                        </div>
    ...
    <?php } ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="date" class="form-control" name="fda"  id="fda" placeholder="dd/mm/yyyy" /> </div>
                          </div>
                        </div>
                      </div>
                 ...
                 <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="avan" id="avan" min="0" max="100" /> </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Fecha estimada inicio</label>
                                <div class="col-sm-9">
                              <input type="date" name="fei" id="fei" class="form-control" placeholder="dd/mm/yyyy" /> </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="date" name="fet" id="fet" class="form-control" /> </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
