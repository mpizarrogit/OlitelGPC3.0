...
<html lang="en">
  <head>
    ...
    <title>Proyectos y Cobranza</title>
    ...
    <div class="container-scroller">
      ...
      $busqueda = strtolower($_REQUEST['busqueda']);
          ...
          if(empty($busqueda)){
              ...
              header("location: principalcobranza.php");
          }
            ?>  
          ...
          <form class="ml-auto search-form d-none d-md-block" action="buscar_todoscob.php" method="get">
                 ...
                 <table class="table table-bordered">
                      ...
                      <tbody id="tmlet">
                       ...
                       $resultado6 = mysqli_query($conexion, $query6);
                            ...
                            if ($suma>=$fila['VALORPROYECTO']){
                                
                                 echo $fila['AVANCE']."%<br>"."<meter max=100 id='barra' value=".$fila['AVANCE']." low='30' high='60' optimun='100'></meter><br><section id='aviso'>Revisar</section></td><td id='tmlet'>";
                                
                            }else{
                                
                                  echo $fila['AVANCE']."%<br>"." <meter max=100 id='barra' value=".$fila['AVANCE']." low='30' high='60' optimun='100'></meter></td><td id='tmlet'>";
