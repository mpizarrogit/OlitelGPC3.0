		  ...
		  <div class="">
			  <div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
				  <h2 class="text-primary">Agregar Fase</h2>
              ...
              <div class="col-8 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoragregarfase.php">
                        
                         <div class="row">
                             
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nombre</label><input type="hidden"  id="proyecto" name="proyecto" value="<?php echo $proyecto;?>">
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nomfase" id="nomfase" required/> </div>
