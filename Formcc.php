  ...
  <body>
          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Agregar CC</h4>
                    ...
                    <form class="form-sample" method="post" action="controladoragregarcc.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nom_cc" id="nom_usuario" required /> </div>
                          </div>
                        </div>
    ...
    ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                  <select  class="form-control" name="agrupacion" id="persona">
            ...
            ?>
                ...
                <option value=" <?php echo$row['ID_AGRUP'] ?>">
                <?php echo $row['NOM_AGRUP']; ?>
                </option>
    ...
    ?>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select  class="form-control" name="detalle" id="persona">
            ...
            ?>
                ...
                <option value=" <?php echo$row2['ID_DETALLE'] ?>">
                <?php echo $row2['DESC_DET']; ?>
                </option>
    ...
    ?>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                  <select  class="form-control" name="linea" id="persona">
            ...
            ?>
                ...
                <option value=" <?php echo$row3['ID_LINEA'] ?>">
                <?php echo $row3['NOM_LINEA']; ?>
                </option>
