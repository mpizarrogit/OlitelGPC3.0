          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">INFORMES DE PAGO EMITIDOS</h4>
                       ...
                       <thead>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php  echo number_format($fila['VALOR_IP'], 0, ",", "."); ?></td>
                            <td><?php echo number_format($fila['VALOR_FACTURADO'], 0, ",", "."); ?></td>
                        ...
                        <?php      
			             ...
			             $resultado2 = mysqli_query($conexion, $consulta2);
                          ...
                          while($ROW = mysqli_fetch_array($resultado2)){ ?>
                            ...
                            <td><?php echo  number_format($ROW['VALORPROYECTO'], 0, ",", "."); ?></td>
                        ...
                        <?php  }  ?>
                            ...
                            echo "Facturado";
                               ...
                               $sql = "UPDATE INFORME_DE_PAGO SET ESTADO='Facturado' WHERE CP = ".$fila['CP'];
                                ...
                                $sql = "UPDATE INFORME_DE_PAGO SET ESTADO='Enviado' WHERE CP = ".$fila['CP'];
                                mysqli_query($conexion, $sql);
                            }
                            ?>
                     </td>
