  ...
  <body>
    <div class="container-scroller">
      ...
      //Validar conexión.
			...
			$consulta = "SELECT * FROM panel WHERE panel.ID_FASE = ".$idfase;
			$resultado = mysqli_query($conexion, $consulta);

			$consulta1 = "SELECT fase.NOM_FASE,concepto.NOMBRE FROM fase inner join concepto on fase.CP=concepto.CP WHERE fase.ID_FASE = ".$idfase;
			$resultado1 = mysqli_query($conexion, $consulta1);      
      
      while($fila2 = mysqli_fetch_array($resultado1)){
 
		$nomFase=utf8_encode($fila2["NOM_FASE"]);
		$proyecto=utf8_encode($fila2["NOMBRE"]);
	}
        ...
        <div class="main-panel">
          <div class="content-wrapper">
			<div class="">
			  ...
			  <p class="text-right">   <a href="visordeactividades.php?idfase=<?php echo $idFase; ?>&p=<?php echo $proyecto; ?>&cp=<?php echo $cp; ?>"><button type="button" class="btn btn-primary"><i class="mdi mdi-view-grid"></i>Ir a Tablero</button></a></p>  
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title"><?php echo ucwords("Proyecto: ".$proyecto ." - Fase: ".$nomFase);?></h3><br>
                    <div class="row">
                        ...
                        <table id="order-listing" class="table ">
                          <thead>
                            <tr class="font-weight-bold">
                              <th class="sortStyle ">PANEL <i class="mdi mdi-chevron-down"></i>
                              </th>
                              <th class="sortStyle">ACTIVIDAD <i class="mdi mdi-chevron-down"></i>
                              </th>
                              <th class="sortStyle">DESCRIPCION <i class="mdi mdi-chevron-down"></i>
                              </th>
							  <th class="sortStyle">ENCARGADO <i class="mdi mdi-chevron-down"></i>
                              </th>
                              <th class="sortStyle">META <i class="mdi mdi-chevron-down"></i>
                              </th> <th class="sortStyle">AVANCE REAL<i class="mdi mdi-chevron-down"></i>
                              </th> <th class="sortStyle"> %  AVANCE<i class="mdi mdi-chevron-down"></i>
                              </th>
                ...
                <?php  while($fila = mysqli_fetch_array($resultado)){ ?>
                            ...
                            <tr style="background-color:#F2F2F2;">
                              <td class="font-weight-bold"><?php echo $fila['NOMBRE_PANEL'];?></td>
							  <td></td>
							  <td></td>
							  <td></td>
							  <td></td>
							 ...
							 <?php 
							  $consulta2 = "SELECT * FROM ACTIVIDAD  where  ID_PANEL=".$fila["ID_PANEL"]. " order by posicion";
							  ...
							  ?>
							     ...
							     <tr>
									  <td> </td>
                              <td><?php echo $fila2["NOM_ACTIVIDAD"]; ?></td>
                              <td><?php echo $fila2["DESC_ACTIVIDAD"];?></td>
							  <td><?php echo $fila2["ENCARGADO"];?></td>
                              <td><?php echo $fila2["META_ACTIVIDAD"];?></td>
                              <td><?php echo $fila2["AVANCE_ACTIVIDAD"];?></td>
                              

							 <td><a href="observacionesAct.php?id=<?php echo $fila2["ID_ACTIVIDAD"]; ?>&nom=<?php echo $fila2["NOM_ACTIVIDAD"]; ?>" title="Ver Detalle de Avance"><?php echo $fila2['PORCENTAJE_ACTIVIDAD']."% <meter max=100 id='barra' value=".$fila2['PORCENTAJE_ACTIVIDAD']." low='30' high='60' optimun='100'></meter>"; ?></a></td> 						
                            </tr>
    ...
    <!-- Custom js for this page -->
	 <script src="./assets/js/shared/modal-demo.js"></script>
