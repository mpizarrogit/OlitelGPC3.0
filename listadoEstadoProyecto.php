  ...
  <body>
    <div class="container-scroller">
      ...
      //Validar conexión.
			...
			$consulta = "SELECT * FROM estado_proyecto";
                    ...
                    <div class="table-responsive">
                      ...
                      <table id="order-listing" class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php  echo $fila['ID_EO_PROYECTO']; ?></td>
                            ...
                            <td>
                               ...
                               <a href='formeditEstadoC.php?id=<?PHP echo $fila['ID_EO_PROYECTO']; ?>'> <section class='imgtb'></section></a>
                             <a href= 'detalleEstadoC.php?id=<?PHP echo $fila['ID_EO_PROYECTO']; ?>'><section class='dtl'></section></a> 
                            </td>
                          </tr>
