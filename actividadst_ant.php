          ...
          <ul class="nav">
           <li class="nav-item nav-profile">
            ...
            <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="./formproyectosadmin.php">Mis Proyectos</a>
                  </li>
             <li class="nav-item">
                    <a class="nav-link" href="./formproyectosadmin.php">Mis Actividades</a>
                  </li>
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td><?php echo $fila['AVANCE_ACTIVIDAD'];?></td>
                                <td>
                             <a title="Completar Actividad" href='completaract.php?idactividad=<?PHP echo $fila['ID_ACTIVIDAD']; ?>&cp=<?PHP echo $cp; ?>'> <section class='check'></section></a>
                             <a title="Avance de Actividad" href= 'formavanact.php?idactividad=<?PHP echo $fila['ID_ACTIVIDAD'];?>&cp=<?PHP echo $cp; ?>'><section class='wrn'></section></a>   
