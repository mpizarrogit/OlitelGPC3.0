			...
			<div class="">
			  <div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
				  <h2 class="text-primary">Avance de Actividad</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="actividadinc.php">
                        
                         <div class="row">
                             
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Avance Real</label>
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="avan" id="avan" required/> </div>
                              
                              
                      <input type="hidden" class="form-control" name="id_fact" id="id_fact" value="<?php  echo $idfactura ?>"/>
         
                      <input type="hidden" class="form-control" name="p" id="p" value="<?php  echo $p ?>"/>
                          </div>
                        </div>
                            <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="com" id="com" required/> </div>
                              
                              
                      <input type="hidden" class="form-control" name="idactividad" id="idactividad" value="<?php  echo $idactividad; ?>"/>
                             ...
                             <button type="submit" class="btn btn-success mr-2">Enviar</button>
                              ...
                              <input class="btn btn-light" type="button" value="Cancelar" onclick="cancelar()"></a>
