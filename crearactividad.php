...
<html lang="en">
			...
			<div class="">
			  <div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
				  <h2 class="text-primary">Nueva Actividad</h2>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladorcrearactividad.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nactividad" id="nactividad" required /> </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="dactividad"  id="dactividad" required/> </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <select  class="form-control" name="tactividad" id="tactividad" required>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="mactividad"  id="mactividad" required /> </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
    ...
    ?>  
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9" name="eactividad" id="eactividad">
                              <select class="form-control" name="eactividad" id="eactividad" required>
							  <option value="" selected> Seleccione </option>
    ...
    <?php } ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="date" class="form-control" name="fiactividad"  id="fiactividad" placeholder="dd/mm/yyyy" /> </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="date" name="ftactividad" id="ftactividad" class="form-control" /> </div>
                          </div>
                        </div>
 ...
 ?>
                              <input name="idpanel" type="hidden" id="idpanel" value="<?php echo $idpanel; ?>" >
