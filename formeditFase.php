		  ...
		  <div class="">
			  <div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
				  <h2 class="text-primary">Editar Fase</h2>
                  ...
                  <div class="card-body">
                    <h4 class="card-title"></h4>
                          ...
                          <?php 
							  ...
							  $sql = "select * from fase where ID_FASE =".$idfase;
    
                        $resultado = $conexion->query($sql);
                    $rows=$resultado->fetch_assoc();

									
										 $nombre=$rows['NOM_FASE']; 
							  ?>	
                    ...
                    <form class="form-sample" method="post" action="controladorEditFase.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nomfase" id="nomfase"  value="<?php  echo $nombre ?>" required/> </div>
	...
	<script>
		function cancelar(){
			if (confirm("¿Está seguro que desea cancelar?")){
				...
				window.location.href="listadofases.php?cp="+cp+"&p="+p;
			}
		}
	</script>
    <!-- inject:js -->
