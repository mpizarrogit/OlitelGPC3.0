		...
		<nav class="sidebar sidebar-offcanvas" id="sidebar">
		  <ul class="nav">
			<li class="nav-item nav-profile">
			 ...
			 <li class="nav-item nav-category">Menú Principal</li><li class='nav-item'><a class='nav-link' href='./principal.php'><i class='menu-icon fa fa-th'></i><span class='menu-title'>Panel</span></a></li> 
					...
					<div class="col-md-6">
					 ...
					 <div class="col-md-6">
						...
						<div class="col-md-6">
						  <div class="form-group row">
							  <?php 
							  $query = "select personas.ID_PERSONAS, personas.NOM_PERSONAS  FROM personas, concepto WHERE personas.ID_PERSONAS = concepto.ID_PERSONAS and concepto.cp ='$cp'";
							
							$result = $conexion->query($query);
							?>
								<label class="col-sm-3 col-form-label">Coordinador de Proyecto:</label>
								 <div class="col-sm-9">
								  <select class="form-control" name="ID_PERSONAS" id="ID_PERSONAS" >
						...
						<div class="col-md-6">
						  ...
						  echo ucfirst($colab['NOM_CARGO'])."";
							echo "<a href= 'controladoreliminarcolab2.php?cp=".$colab['CP']."&persona=".$colab['ID_PERSONAS']."&cargo=".$colab['ID_CARGO']."'><section class='elim'></section></a> </td>"; echo "</br>";
						}
						  ?>
								</section>
							  </div>
							 ...
							 <button type="submit" class="btn btn-success mr-2">Editar</button>
							  <a href="listadoproyectos.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
							<span class=" float-none float-sm-right d-block mt-1 mt-sm-0 text-center">	<a href="formagregarolitel.php?cp=<?php	 echo $cp;?>"><input class="btn btn-secondary" type="button" value="Agregar Colaboradores Olitel"></a>
			  </span>
					</form>
				  </div>
				</div>
