              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="controladoringresarusuario.php">
                      <p class="card-description"> Agrega usuarios</p>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nom_usuario" id="nom_usuario" required /> </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="rut_usuario"  id="rut_usuario" /> </div>
                          </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="clave_usuario"  id="clave_usuario" /> </div>
                          </div>
                            <input name="fdc" type="hidden" id="fdc" value="<?php echo $hoy ?>" >
                             ...
                             <button type="submit" class="btn btn-success mr-2">Agregar</button>
                              <a href="listadousuarios.php"><input class="btn btn-light" type="button" value="Cancelar"></a>
