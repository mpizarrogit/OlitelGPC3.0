    ...
    <div class="container-scroller">
     ...
     <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      $busqueda = strtolower($_REQUEST['busqueda']);
          ...
          if(empty($busqueda)){
            ...
            <form class="ml-auto search-form d-none d-md-block" action="buscarip.php" method="get">
     ...
     <?php
      ...
      //Validar conexión.
			...
			$sql_registe = mysqli_query($conexion,"SELECT * FROM INFORME_DE_PAGO WHERE (
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">IP EMITIDOS</h4>
<p>   <a href="generar_excel_cobr.php"><button type="button" class="btn btn-default"><img src="img/microsoft-excel.png" width="16px" height="16px"> Generar Excel</button></a></p>
                 ...
                 <table class="table table-bordered">
                      <thead>
                        <tr>
                          <th id='tmlet'> IP </th>
                          <th id='tmlet'> CP</th>
                          <th id='tmlet'> VALOR IP </th>
                          
                          <th id='tmlet'> VALOR IP FACTURADO </th>
                          <th id='tmlet'> VALOR PROYECTO </th>
                          <th id='tmlet'> FECHA IP </th>
                          <th id='tmlet'> ESTADO IP </th>
                      ...
                      <tbody>
                        ...
                        echo "<tr><td id='tmlet'>"; 
                          ...
                          echo $fila['NIP']."</td><td id='tmlet'>";
                          echo $fila['CP']."</td><td id='tmlet'>";
                          echo number_format($fila['VALOR_IP'], 0, ",", ".")."</td><td id='tmlet'>";
                          echo number_format($fila['VALOR_FACTURADO'], 0, ",", ".")."</td><td id='tmlet'>";
                            
                        $consulta2 = "SELECT * FROM CONCEPTO WHERE CONCEPTO.CP =".$fila['CP'];
			             $resultado2 = mysqli_query($conexion, $consulta2);
    
                          while($ROW = mysqli_fetch_array($resultado2)){ 
                          echo  number_format($ROW['VALORPROYECTO'], 0, ",", ".")."</td><td id='tmlet'>";
    
                          }
    
                            echo $fila['FECHAENVIOIP']."</td><td id='tmlet'>";
                        ...
                        echo  "<td><a href='formeditip.php?ID_IP=".$fila['ID_IP']."'><section class='imgtb'></section></a></td>";
