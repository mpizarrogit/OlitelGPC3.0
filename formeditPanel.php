		  ...
		  <div class="">
			  <div class="card-body">
				<div class="d-flex justify-content-between border-bottom">
				  <h2 class="text-primary">Editar Panel</h2>
                  ...
                  <div class="card-body">
                    <h4 class="card-title"></h4>
                          ...
                          <?php 
							  ...
							  $sql = "select * from panel where ID_PANEL=".$idpanel;
    
                        $resultado = $conexion->query($sql);
                    $rows=$resultado->fetch_assoc();

									
										 $nombre=$rows['NOMBRE_PANEL']; 
							  ?>	
                      
                    <form class="form-sample" method="post" action="controladoreditPanel.php">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="NOMBRE_PANEL" id="NOMBRE_PANEL"  value="<?php  echo $nombre ?>" required/> </div>
                              
                              
                      <input type="hidden" class="form-control" name="cp" id="cp" value="<?php  echo $cp ?>"/>
					     <input type="hidden" class="form-control" name="idpanel" id="idpanel" value="<?php  echo $idpanel ?>"/>
						 <input type="hidden" class="form-control" name="idfase" id="idfase" value="<?php  echo $idfase ?>"/>
	...
	<script>
		function cancelar(){
			if (confirm("¿Está seguro que desea cancelar?")){
				...
				var idpanel= document.getElementById("idpanel").value;
				var idfase= document.getElementById("idfase").value;
				window.location.href="listadoPanel.php?idpanel="+idpanel+"&idfase="+idfase+"&cp="+cp+"&p="+p;
			}
		}
	</script>
    <!-- inject:js -->
